...
def get_racks():  # noqa: E501
    ...
    """
    response = []
    response.append(Rack(id='1', label='rack1', description='rack1 description'))
    response.append(Rack(id='2', label='rack2', description='rack2 description'))
    return response
